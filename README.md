...
PianoVirtual/
│
├── piano.html          # Arquivo principal (HTML + CSS + JS)
...
3. Abra o arquivo `piano.html` no seu navegador preferido

Ou simplesmente arraste o arquivo `piano.html` para o navegador.
